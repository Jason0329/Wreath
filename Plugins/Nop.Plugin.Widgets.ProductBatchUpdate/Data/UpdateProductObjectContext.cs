...
{
    public class UpdateProductObjectContext : DbContext, IDbContext
    {
        public UpdateProductObjectContext(string nameOrConnectionString) : base(nameOrConnectionString) { }
        ...
        {
            modelBuilder.Configurations.Add(new UpdateProductMap());
