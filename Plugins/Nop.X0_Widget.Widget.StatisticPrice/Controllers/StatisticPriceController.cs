...
using Nop.X0_Widget.Widget.StatisticPrice.Service;
using System;
...
namespace Nop.X0_Widget.Widget.StatisticPrice.Controllers
{
    public class StatisticPriceController : BasePluginController
    {
        ...
        public StatisticPriceController(IRepository<StatisticPriceMonthly> StatisticPriceMontlyRepository,ILogger logger
        ...
        public ActionResult Configure()
        {
            ...
            return View("~/Plugins/Widget.StatisticPrice/Views/Admin/Configure.cshtml", model);
        }
        ...
        public ActionResult StatisticCarPrice(int ProductID)
        {
            ...
            //..\..\Presentation\Nop.Web\Plugins\BadPayBad.HelloWorld\
            //the view file .cshml depend your output path
            return View("~/Plugins/Widget.StatisticPrice/Views/_StatisticCarPrice.cshtml", model);
        }

        //public ActionResult LastMonthCarPrice(int ProductID)
        //{
        ...
        //    var model = model_Select.StatisticPriceMontlyList[model_Select.StatisticPriceMontlyList.Count - 1].MonthlyAveragePrice;

        //    return View("~/Plugins/Widget.StatisticPrice/Views/_LastMonthCarPrice.cshtml", model);
        //}

        public ActionResult StatisticPrice()
        {
            return View();
        }

        public ActionResult StatisticPriceList()
        {
