...
namespace Nop.X0_Widget.Widget.StatisticPrice
{
    public class StatisticPricePlugin : BasePlugin, IWidgetPlugin, IAdminMenuPlugin
    {
           ...
           out RouteValueDictionary routeValues)
        {
            ...
            controllerName = "StatisticPrice";
            routeValues = new RouteValueDictionary()
           {
               { "Namespaces", "Nop.X0_Widget.Widget.StatisticPrice.Controllers" },
               { "area", null }
           };
        }
        ...
        {
            return new List<string>() { "product_page_statistic_price"};//, "productlist_page_last_month_price" };
        }
        ...
        public void ManageSiteMap(SiteMapNode rootNode)
        {
            ...
            {
                SystemName = "StatisticPriceList",
                Title = "Statistic Price List",
                ControllerName = "StatisticPrice",
                ActionName = "StatisticPriceList",
                Visible = true,
           ...
           // _LocalizationService.InsertLocaleStringResource(new LocaleStringResource { ResourceName = "LastMonth.PriceTrend", ResourceValue = "至上月止車價成交趨勢" });
            ...
            for (int i = 0; i < 13; i++)
            {
                for (int j = 0; j < 10; j++)
                {
                    ...
                    _StatisticPriceMonthly.MonthlyAveragePrice = 6430000 - 100000 * i;
