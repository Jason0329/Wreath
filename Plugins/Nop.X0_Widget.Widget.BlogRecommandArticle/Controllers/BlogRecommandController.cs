...
using Nop.X0_Widget.Widget.BlogRecommandArticle.Domain;
using Nop.Core.Domain.Seo;

namespace Nop.X0_Widget.Widget.BlogRecommandArticle.Controllers
{
    public class BlogRecommandController : BasePluginController
    {
        private ILogger _logger;
        private IBlogService _blogService;
        private IRepository<UrlRecord> _blogUrl;

        public BlogRecommandController(ILogger logger, IBlogService blogService , IRepository<UrlRecord> blogUrl)
        {
            _logger = logger;
        ...
        public ActionResult BlogRecommandPost(object additionalData = null)
        {
            ...
            foreach (var _blog in BrandBlog)
            {
                ...
                RecommandArticle.BrandRelated.Add(new BlogRecommandArticleClass(_blog.Title, _blog.BodyOverview, BlogLink));
            }
            ...
            {
                string BlogLink = _blogUrl.Table.Where(m => m.EntityId == _blog.Id).Select(m => m.Slug).FirstOrDefault().ToString();
                RecommandArticle.RecentlyArticle.Add(new BlogRecommandArticleClass(_blog.Title, _blog.BodyOverview, BlogLink));
            }
            ...
            return View("~/Plugins/Widget.BlogRecommandArticle/Views/_BlogRecommand.cshtml",(object)RecommandArticle);//, (object)model);
        }
        ...
        public ActionResult Configure()
        {
            ...
            return View("~/Plugins/Widget.BlogRecommandArticle/Views/Admin/Configure.cshtml", model);
        }
