...
{
    public class GameObjectContext : DbContext, IDbContext
    {
        public GameObjectContext(string nameOrConnectionString) : base(nameOrConnectionString) { }
        ...
        public void Install()
        {
            ...
            Database.SetInitializer<GameObjectContext>(null);
        ...
        {
            var dbScript = "DROP TABLE LBSGame_Game";
